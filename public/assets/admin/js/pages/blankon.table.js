...
var BlankonTable = function () {
    ...
    return {
        ...
        datatable: function () {
            ...
            tableAjax.dataTable({
                autoWidth      : true,
                ajax           : 'http://localhost/lppm_blankon/public/ajax/proposes/getbyscheme?period_id=' + $('#scheme-assign-reviewer').val(),
                // $.get('http://localhost/lppm_blankon/public/ajax/proposes/getbyscheme', {period_id: $(this).val()}, function(data) {
