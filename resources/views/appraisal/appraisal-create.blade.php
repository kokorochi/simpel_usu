            ...
            <div class="col-md-12">
                <div class="panel rounded shadow">
                    ...
                    <div class="panel-body no-padding">
                        <form class="form-horizontal form-bordered submit-form" action="{{url('appraisals/create')}}" method="POST">
                            <div class="form-body">
                                ...
                                <div class="input_fields_wrap">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input name="name" class="form-control input-sm" type="text" value="{{ old('name') }}">
                                            @if($errors->has('name'))
                                ...
                                @else
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            @if($errors->has('aspect.0'))
                                                <label class="error" for="aspect[]" style="display: inline-block;">
                                                    {{ $errors->first('aspect.0') }}
                                                </label>
                                            @endif
                                        </div>
                                        <label class="col-sm-1 control-label">Bobot</label>
                                        <div class="col-sm-2">
                                            <input name="quality[]" class="form-control input-sm" type="text">
                                            @if($errors->has('quality.0'))
                                                <label class="error" for="quality[]" style="display: inline-block;">
                                                    {{ $errors->first('quality.0') }}
                                                </label>
                                            @endif
                                        </div>
                                        <div class="col-sm-1">
