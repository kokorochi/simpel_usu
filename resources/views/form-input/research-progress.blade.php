        ...
        <div class="panel">
            ...
            <div class="panel-body no-padding">
                <div class="form-body form-horizontal form-bordered">
                    @if($research->file_progress_activity !== null)
                            ...
                            <div class="col-sm-7 mb-10">
                                <div class="input-group">
                                    <input name="file_progress_activity" class="form-control input-sm"
                                           type="text" disabled
                                           value="{{ $research->file_progress_activity_ori }}">
                                        <span class="input-group-btn">
                                            <a href="{{url('researches', $research->id) . '/download/1' }}"
                    ...
                    @if($research->file_progress_budgets !== null)
                        <div class="form-group">
                            ...
                            <div class="col-sm-7 mb-10">
                                <div class="input-group">
                                    <input name="file_progress_budgets" class="form-control input-sm"
                                           type="text" disabled
                                           value="{{ $research->file_progress_budgets_ori }}">
                                        <span class="input-group-btn">
                                            <a href="{{url('researches', $research->id) . '/download/2' }}"
                                               class="btn btn-primary btn-sm">Unduh</a>
                                        </span>
                                </div>
                            </div>
