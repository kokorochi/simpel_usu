...
$errors->has('end_date') || old('end_date'))
    @php
        ...
        $lecturer = \App\ModelSDM\Lecturer::where('employee_card_serial_number', $auths['nidn'])->first();
    @endphp
@endif
{{--Get Old Value And Place It To VARIABLE--}}
                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            <div class="panel-heading">
                                <div class="pull-left">
                                    <h3 class="panel-title">Tambah Reviewer</h3>
                                </div>
                            ...
                            <div class="panel-body no-padding">
                                <div class="form-body form-horizontal form-bordered">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="full_name" class="input-reviewer input-member form-control input-sm"
                                                   type="text"
                                                   value="{{$auths->full_name}}">
                            ...
                            <div class="panel-body no-padding">
                                <div class="form-body form-horizontal form-bordered">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="employee_card_serial_number" class="form-control input-sm" type="text" value="{{$lecturer->employee_card_serial_number}}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-4 col-md-3 control-label">NIP</label>
                                        <div class="col-sm-7">
                                            <input name="number_of_employee_holding" class="form-control input-sm" type="text" value="{{$lecturer->number_of_employee_holding}}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-4 col-md-3 control-label">Program Studi</label>
                                        <div class="col-sm-7">
                                            <input name="study_program" class="form-control input-sm" type="text" value="{{$lecturer->study_program}}" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
